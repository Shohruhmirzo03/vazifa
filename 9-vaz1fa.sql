...
SELECT city FROM customers INNER JOIN employees on customers.customer_id = employees.employee_id;

SELECT city FROM customers LEFT JOIN employees on customers.customer_id = employees.employee_id
